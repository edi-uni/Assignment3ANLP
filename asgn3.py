...
# Get target similarities using Path, Leacock-Chodorow and Wu-Palmer Similarities algorithms
...
# Compute similarities using Cosine Jaccard and Dice algorithms just for feelings 
...
# Compute similarities using Cosine Jaccard and Dice algorithms for both,
# feeling and other words (in our case: 'osama' and 'obama')
...
# Save target similarities into files
...
# Sort keys for target similarities dictionaries in ascend order
...
# Print the RMSE between targets and actual similarities computed
print('#'*80)
